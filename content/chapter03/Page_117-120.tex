%%%%%%%%%%%%%%%%%%%
%% 
%%  Student : علی سلامتی خیاوی
%%   Github : https://github.com/alisalamati/PNU_3991_AR/tree/main/Theory-of-Languages-and-Machines/latex-(.tex)
%%
%%      Ref : - Shyamalendu Kandar - Introduction to Automata Theory, Formal Languages and Computation-Pearson Education India (2016)
%%    Pages : 117 to 120
%%
%%     Date : 3991   
%%
